...
// void VectorOneVariableInterface::scale(const arma::vec& scale){_notWritten("scale");}
// void VectorOneVariableInterface::scaleinv(const arma::vec& scale){_notWritten("scaleinv");}
...
void VectorOneVariableInterface::setVectorFromDirectSolver(int offset, const arma::vec& u){_notWritten("setVectorFromDirectSolver");}
void VectorOneVariableInterface::addVectorRhsForDirectSolver(int offset, arma::vec& f) const{_notWritten("addVectorRhsForDirectSolver");}
